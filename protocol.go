...
ErrMessage details:
//BYTE0
Uint16 TzProtectFault:1;//0 Uint16 MainsLostFault:1;//1 Uint16 GridVoltFault:1;//2
Uint16 GridFreqFault:1;//3
Uint16 PLLLostFault:1;//4
Uint16 BusVoltFault:1;//5
Uint16 BIT06:1;//6
Uint16 OciFault:1;//7 OciFault; //BYTE1
Uint16 Dci_OCP_Fault:1;//8
Uint16 ResidualCurrentFault:1;//9 Uint16 PvVoltFault:1;//10
...
Uint16 SampleConsistenceFault:1;//22 Uint16 ResidualCurrent_DeviceFault:1;//23 //BYTE3
Uint16 BIT24:1;//24
Uint16 BIT25:1;//25
Uint16 BIT26:1;//26
Uint16 BIT27:1;//27
